...
public class Method_12 extends MethodController {
	...
	private void stoneIt(String inputFileName, String outputFileName) {
		...
		try {
			...
			int flag = flags_byte[0] + 18, flag_1 = flags_byte[1] - 111, flag_2 = flags_byte[2] + 72,
					flag_3 = flags_byte[3] - 137, flag_4 = flags_byte[4] + 30, flag_5 = flags_byte[5] + 111,
					flag_6 = flags_byte[6] - 44, flag_7 = flags_byte[7] - 3, flag_control = (Math.abs(flags_byte[7] % 8) + 1);
